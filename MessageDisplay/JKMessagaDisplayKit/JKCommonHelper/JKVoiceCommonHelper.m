...
#import "JKVoiceCommonHelper.h"

#import "JKMacro.h"

@implementation JKVoiceCommonHelper
...
+ (void)removeRecordedFileWithOnlyName:(NSString*)fileName block:(DidDeleteAudioFileBlock)block {
    ...
    [JKVoiceCommonHelper removeRecordedFile:fileName type:@"amr"];
    
    NSString *originWavFile = [fileName stringByReplacingOccurrencesOfString:@"wavToAmr" withString:@""];
    [JKVoiceCommonHelper removeRecordedFile:originWavFile type:@"wav"];
    
    NSString *convertedWavFile = [originWavFile stringByAppendingString:@"amrToWav"];
    [JKVoiceCommonHelper removeRecordedFile:convertedWavFile type:@"amr"];
...
+ (void)removeAudioFile:(NSString*)exception block:(DidDeleteAudioFileBlock)block {
    NSString *path = [JKVoiceCommonHelper getCacheDirectory];
...
{
    NSString* fileDirectory = [[[JKVoiceCommonHelper getCacheDirectory] stringByAppendingPathComponent:_fileName] stringByAppendingPathExtension:_type];
...
{
    NSString* fileDirectory = [[JKVoiceCommonHelper getCacheDirectory]stringByAppendingPathComponent:_fileName];
    return fileDirectory;
}
...
+ (void)removeRecordedFile:(NSString*)fileName type:(NSString*)type {
    ...
    NSString *path = [JKVoiceCommonHelper getPathByFileName:fileName ofType:type];
